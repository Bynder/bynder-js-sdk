...
class Bynder {
   ...
   * @param {int} params.page offset page for results: return the N-th set of limit-results
   * @param {String} params.orderBy order of the returned list of tags.
   * @param {String} params.keyword Search on matching names
   * @param {String} params.mincount Minimum media count that the returned tags should have.
